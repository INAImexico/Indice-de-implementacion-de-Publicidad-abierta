...
<div class="rellenar fijo"></div>
    <div class="container">
		<div class="row">
			<div class="col-xs-4 col-md-4"> 
				<a href="http://inicio.inai.org.mx" target="_blank">
				<img src="<?php echo URL_BASE; ?>img/INAIheader.png" class="fijo" style="max-width: 100%; height: auto; margin-top:30.25px;"/>
				</a>
			</div>
            <div class="col-xs-4 col-md-4 fijo">
				<a>
				<img src="<?php echo URL_BASE; ?>img/Publicidad_1.png" class="fijo" style="left: 0; right: 0; margin: auto; margin-top:23.75px; max-width: 100%; height: auto;"/> 
				</a>
			</div> 
		    <div class="col-xs-4 col-md-4 fijo">
				<a href="http://publicidadabierta.inai.org.mx/index.php/tpov1" target="_blank">
		        <img src="<?php echo URL_BASE; ?>img/Publicidad.png" class="fijo" style="margin-left: 180px; max-width: 100%;  height: auto;"
